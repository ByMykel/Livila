                ...
                <div class="px-4 py-5 bg-black-300 space-y-6 sm:p-6">
                    <div class="col-span-6">
                        ...
                        <input
                            ...
                            name="list_name"
                            id="list_name"
                            class="text-black mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea
                                ...
                                name="description"
                                rows="5"
                                class="text-black disabled:opacity-50 shadow-sm mt-1 block w-full sm:text-sm border-gray-300 rounded-md"
